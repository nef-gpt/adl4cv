...
gif_file="../submissions/presentation_1/public/comparison_11_35_47_65/unconditioned_65.gif"

# Extract the base name of the file (without extension)
base_name=$(basename "$gif_file" .gif)

# Define the output file name
png_file="../submissions/presentation_1/public/comparison_11_35_47_65/${base_name}_last_frame.png"
