...
def get_param_structure(path: str):
    ...
    with h5py.File(hdf5_path, "r") as hdf5_file:
        param_structure = json.loads(hdf5_file["param_config"][0].decode("utf-8"))
        return param_structure

# Taken for neural field arena
...
class NeuralFieldArenaDataset(BaseDataset):
    def __init__(
        self,
        path: Union[str, Path],
        dataset: str,
        ...
        Args:
            ...
            dataset: str: The name of the dataset to load (either CIFAR10, MicroImageNet, MINST or ShapeNet)
        ...
        path = path / "neural_field_arena" / dataset / "SIREN"
