...
def main(weights, dims =[17], vocab_sizes=[1024], batch_sizes = [2**15], threshold_ema_dead_codes = [0], kmean_iters_list = [0], groups_list=[1], num_quantizers_list=[1], use_inits=[True], force=False, training_iters=1):
